...
const getS3ForPass = async (passphrase) => {
    ...
    try {
        const s3 = new S3({ params: { ...creds }, region, signatureVersion })
...
const validateToken = async (token) => {
    ...
    const s3 = validateTokenTime(decrypted) &&
                await validateTokenCipher(decrypted)
...
module.exports = { genToken, validateToken, validateTokenCipher, validatePassphrase: getS3ForPass, openS3ForToken }